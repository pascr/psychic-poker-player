...
public class PokerFileReaderTest
{
    ...
    @Test
    public void should_read_lines_and_pass_them_to_line_parser() throws InvalidLineException, CannotParseFileException, InvalidFaceValueException, InvalidSuitValueException
    {
